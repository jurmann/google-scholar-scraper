...
quote_page_2 = "https://link.springer.com/article/10.1007/s00253-010-2622-3"
# query the website and return the html to the variable
page = urllib2.urlopen(quote_page_2)
...
print price_box.get('title')

# <ul class="test-contributor-names">


# <a href="mailto:rzeng@ustc.edu.cn" title="rzeng@ustc.edu.cn" itemprop="email" class="gtm-email-author">Email author</a>
